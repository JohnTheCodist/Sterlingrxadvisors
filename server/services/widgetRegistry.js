...
const WIDGETS = [
...

  {
    ...
    description: 'The profit sitting on your shelves: what stock would earn above what it cost, if all of it sold at recorded prices. Products missing either price are excluded, never counted as free.',
    dashboard: 'inventory',
    section: 'Financial',
    category: 'KPIs',
    priority: 3,
...

  {
    ...
    description: 'Gross margin this inventory would return at recorded prices, against the 20–40% range typical for a Nigerian pharmacy. Profit and revenue come from the same fully-priced products, never mixed.',
    dashboard: 'inventory',
    section: 'Financial',
    category: 'KPIs',
    priority: 4,
...

  {
    ...
    description: 'Money in stock expiring within 90 days, valued at what you paid. This is the cash you write off if none of it sells, and the window in which a promotion or supplier return can still recover it.',
    dashboard: 'expiry',
    section: 'Risk',
    category: 'KPIs',
    priority: 1,
...

  {
    ...
    description: 'Stock past its expiry date, valued at cost. Money already lost rather than at risk — shown so it is written off deliberately and pulled from the shelf, not left inflating inventory value.',
    dashboard: 'expiry',
    section: 'Risk',
    category: 'KPIs',
    priority: 2,
...

  {
    ...
    description: 'Shelf life left on stock on hand, weighted by units so a large batch counts more than a single pack. A short average means expiry pressure is broad, not confined to a few lines.',
    dashboard: 'expiry',
    section: 'Risk',
    category: 'KPIs',
    priority: 3,
