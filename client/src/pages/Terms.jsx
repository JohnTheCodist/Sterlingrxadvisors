      ...
      <div className="shell">
        ...
        <div className="legal-content">
          ...
          <ul>
            ...
            <li>You must provide accurate information when creating an account and naming your organization.</li>
            <li>One organization may have multiple staff accounts in the future; for now, each organization is created and owned by the user who set it up.</li>
          </ul>
          ...
          <p>
            You're responsible for making sure you have the right to upload the data you provide —
            for example, that including customer names or contact details in an upload complies
            with whatever privacy notice or consent you've given your own customers.
          </p>

          <h2>5. The AI Advisor</h2>
          <p>
            The AI Advisor answers questions using tools that query your real uploaded data — it's
            designed to never invent figures. Even so, AI-generated text can occasionally be wrong
            or misleading. Treat its answers as a starting point for your own judgment, not as
            financial, medical, tax, or legal advice, and verify anything business-critical before
            acting on it.
          </p>
          ...
          <ul>
            <li>Upload data you don't have the right to upload, or that violates a third party's rights.</li>
            <li>Attempt to access another organization's data, or probe, scan, or bypass the Service's access controls.</li>
            <li>Use the Service to build a competing product, or resell access without our agreement.</li>
            <li>Interfere with the Service's operation (e.g. excessive automated requests intended to disrupt it).</li>
          </ul>
          ...
          <p>
            ...
            suspend or terminate accounts that violate these terms, with notice where reasonably
            possible.
          </p>
